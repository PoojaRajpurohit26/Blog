...
public final class dashboard_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(c==null){
      ...
      out.write("\t\t$.post(\n");
      out.write("\t\t\t\"add_category.jsp\",{category:category},function(data){\n");
      out.write("                                data=data.trim();\n");
      out.write("\t\t\t\t$(\".table-borderless\").prepend(\"<tr id='\"+data+\"'><td id='category-\"+data+\"'>\"+category+\"</td><td><i rel='\"+data+\"' class='fa fa-edit'></i></td><td><i rel='\"+data+\"' class='fa fa-trash'></i></td></tr>\");\n");
      out.write("                                $(\"#msg\").attr(\"class\",\"alert alert-success\");\n");
      out.write("                                $(\"#msg\").text(\"Record Inserted\");\n");
      out.write("\t\t\t}\n");
      out.write("\t\t);\n");
      out.write("\t});\n");
      ...
      out.write("\t\t$.post(\n");
      out.write("\t\t\t\"delete.jsp\",{id:id},function(data){\n");
      out.write("                                data=data.trim();\n");
      out.write("                                if(data==\"success\"){\n");
      out.write("                                    $(\"#\"+id).fadeOut(1000);\n");
      out.write("                                    $(\"#msg\").attr(\"class\",\"alert alert-primary\");\n");
      out.write("                                    $(\"#msg\").text(\"Record Deleted\");\n");
      out.write("                                }\n");
      out.write("                                else{\n");
      out.write("                                    $(\"#msg\").attr(\"class\",\"alert alert-danger\");\n");
      out.write("                                    $(\"#msg\").text(\"Record not deleted....Try again\");\n");
      out.write("                                }\n");
      out.write("\t\t\t}\n");
      out.write("\t\t);\n");
      out.write("\t});\n");
      out.write("\t$(document).on(\"click\",\".fa-edit\",function(){\n");
      out.write("                $(\"#msg\").removeAttr(\"class\");\n");
      out.write("                $(\"#msg\").text(\"\");\n");
      out.write("\t\tvar id = $(this).attr(\"rel\");\n");
      out.write("\t\tvar category = $(\"#category-\"+id).text();\n");
      out.write("\t\t$(\"#category-\"+id).html(\"<input type='text' id='cat-\"+id+\"' value='\"+category+\"' class='form-control'>\");\n");
      out.write("\t\t$(this).attr(\"class\",\"fa fa-save\");\n");
      out.write("\t});\n");
      out.write("\t$(document).on(\"click\",\".fa-save\",function(){\n");
      out.write("\t\tvar id = $(this).attr(\"rel\");\n");
      out.write("\t\tvar category = $(\"#cat-\"+id).val();\n");
      out.write("\t\t$(this).attr(\"class\",\"fa fa-edit\");\n");
      out.write("\t\t$.post(\n");
      out.write("\t\t\t\"update.jsp\",{code:id,category:category},function(data){\n");
      out.write("\t\t\t\tdata=data.trim();\n");
      out.write("                                if(data==\"success\"){\n");
      out.write("                                    $(\"#category-\"+id).html(\"<h5>\"+category+\"</h5>\");\n");
      out.write("                                    $(\"#msg\").attr(\"class\",\"alert alert-info\");\n");
      out.write("                                    $(\"#msg\").text(\"Record Updated\");\n");
      out.write("                                }\n");
      out.write("                                else{\n");
      out.write("                                    $(\"#msg\").attr(\"class\",\"alert alert-danger\");\n");
      out.write("                                    $(\"#msg\").text(\"Try again\");\n");
      out.write("                                }\n");
      out.write("\t\t\t}\n");
      out.write("\t\t);\n");
      out.write("\t});\n");
      ...
      out.write("\t\t\t\t\t<label><h4>Category</h4></label>\n");
      out.write("\t\t\t\t\t<input type=\"text\" id=\"category\" class=\"form-control\" required><br>\n");
      out.write("                                        <button class=\"btn btn-primary\">Add Category</button>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<br><br>\n");
      out.write("\t\t\t<div class=\"row\">\n");
      ...
      out.write("                                            <thead class=\"w3-blue\">\n");
      out.write("                                                <tr><td>Category</td><td></td><td></td></tr>\n");
      out.write("                                            </thead>\n");
      out.write("                                            <tbody>\n");
      out.write("\t\t\t\t\t\t");
